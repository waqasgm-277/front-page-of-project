...
document.querySelector('.prev').addEventListener('click', () => {
 ...
 .then(json => {
    ...
    for (let data of json){
      ...
      <div class="card" style="width: 16rem;border: none;box-shadow: 0px 0px 3px 0px  gray; "  >

           <img src="${data.p_image}" class="product-img" alt="..." style="border-radius: 20px;">


           <div class="card-body" style="border-radius:10px;box-shadow: 0px 0px 3px 0px  gray;" >
